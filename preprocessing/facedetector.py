...
def maindetector(img):
    ...
    fsave = open('/data5/Faces/imgroi.txt', 'w')
...
#            cv2.rectangle(img, (int(boundingboxes[i][0]), int(boundingboxes[i][1])), (int(boundingboxes[i][2]), int(boundingboxes[i][3])), (0,255,0), 1)    
	...
	outstr = "" + imgpath + " " + str(boundingboxes[0][0]) + " " + str(boundingboxes[0][1]) + " " + str(boundingboxes[0][2]-boundingboxes[0][0]) + " " + str(boundingboxes[0][3]-boundingboxes[0][1])
	fsave.write(outstr + "\n")
