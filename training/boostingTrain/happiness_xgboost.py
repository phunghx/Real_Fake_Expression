...
X_test = []
y_test = []
trainPath = '../results_happy/'
classes = ['N2H.npy','S2N2H.npy']
classesName = {}
...
model = XGBClassifier(learning_rate=0.0055,silent=True,n_estimators=5000,subsample=1,reg_lambda=100)
model.fit(X, y, early_stopping_rounds=6500,eval_metric="error", eval_set=eval_set, verbose=False)
import pickle
pickle.dump(model, open("../../happy/model.dat","wb"))
