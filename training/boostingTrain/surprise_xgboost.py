...
trainPath = '../results_surprise/'
classes = ['N2Sur.npy','D2N2Sur.npy']
classesName = {}
...
model = XGBClassifier(learning_rate=0.0055,silent=True,n_estimators=1500,subsample=1,reg_lambda=10)
model.fit(X, y, early_stopping_rounds=1500,eval_metric="error", eval_set=eval_set, verbose=False)
pickle.dump(model, open("../../surprise/model.dat","wb"))
